...
/**
 * 统计设备表：组合唯一键 mac + imei + androidid
 * 
 * @author srain12
 */
@Entity
@Table(name = "co_device")
public class PartnerDevice implements java.io.Serializable {
    ...
    public PartnerDevice(Date accesstime, Long countryid, String countryname, String customid, String osVersionCode, String osVersionName, String imei, String mac,
