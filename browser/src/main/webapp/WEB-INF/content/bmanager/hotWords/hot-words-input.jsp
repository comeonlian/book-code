...
<div class="currloca">
  <p>${auth.fullMenu}${id==null?'&nbsp;»&nbsp;<span>新增</span>':'&nbsp;»&nbsp;<span>修改</span>' }</p>
  <div class="sitemap">
...
<div class="container">
  <!-- 内容区域 -->
  <div class="itemtitle"><h2>${id==null?'新增':'修改' }</h2></div>
  ...
  <form id="inputForm" action="hot-words!save.action" method="post">
	  <!-- 列表区域-->
