...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="customer!list.action" method="post">
  ...
  <div id="operate" class="operate">
    <div><img src="${ctx}/images/b_add.gif" alt="增加" onclick="opr_input('customer!input.action',false,'${authId}');"/></div>
    <div><img src="${ctx}/images/b_edit.gif" alt="修改" onclick="opr_update('customer!input.action','mainForm',false,'${authId}');" /></div>
