 ...
 * @author hu
 */
public class NewsCrawler1 extends BreadthCrawler {
	 ...
	 */
	public NewsCrawler1(String crawlPath, boolean autoParse) {
	...
	public static void main(String[] args) throws Exception {
		NewsCrawler1 crawler = new NewsCrawler1("crawl", true);
