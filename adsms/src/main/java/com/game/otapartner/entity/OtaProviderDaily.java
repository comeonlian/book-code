 ...
 */
@Entity
@Table(name = "ota_co_provider_daily")
public class OtaProviderDaily extends AuditableEntity {
    ...
    public boolean equals(Object o) {
        boolean res = false;
        if (o != null && OtaProviderDaily.class.isAssignableFrom(o.getClass())) {
            OtaProviderDaily s = (OtaProviderDaily) o;
