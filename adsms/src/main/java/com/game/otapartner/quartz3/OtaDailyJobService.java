package com.game.otapartner.quartz3;
...
@Service("otaDailyJobService")
public class OtaDailyJobService {
    ...
    public void initOtaProviderDaily() {
        ...
        sb.append(" INSERT IGNORE INTO ota_co_provider_daily(customer_id,currentdate,realnum,opennum,create_time,status,unitprice)                                           ")
                ...
                .append(" (SELECT customid,countryid,DATE(accesstime) accessdate,count(deviceid)realnum from ota_co_device WHERE 1=1 AND accesstime<CURDATE() and accesstime>(CURDATE() - interval 30 day)  ")
                .append(" GROUP BY customid,DATE(accesstime),countryid) bb   LEFT JOIN  ota_customer pc ON pc.customerid=bb.customid ) hh WHERE hh.customid is not null ");
