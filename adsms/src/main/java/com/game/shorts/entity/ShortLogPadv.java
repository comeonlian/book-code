 ...
 */
@Entity
@Table(name = "short_log_padv")
public class ShortLogPadv implements java.io.Serializable {
    ...
    public ShortLogPadv(Date accesstime, String deviceid, String ip, Long countryId, String customerid, String imsi, Long padvid) {
        super();
