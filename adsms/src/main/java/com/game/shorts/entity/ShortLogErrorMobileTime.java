 ...
 */
@Entity
@Table(name = "short_log_error_mobile_time")
public class ShortLogErrorMobileTime implements java.io.Serializable {
    ...
    public ShortLogErrorMobileTime() {
        super();
    }

    public ShortLogErrorMobileTime(Date accesstime, String deviceid, String ip, Long countryId, String countryName, String url, String mac, String imei, String imsi,
