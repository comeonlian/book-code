...
public class ApkEntry {
	...
	public String toString() {
		return "ApkEntry [apkSize=" + apkSize + ", apkVersion=" + apkVersion
				+ ", apkPackage=" + apkPackage + ", apkIcon=" + apkIcon
				+ ", apkIconPath=" + apkIconPath + ", apkIconUrl=" + apkIconUrl
				+ ", apkIconMd5=" + apkIconMd5 + ", apkName=" + apkName
				+ ", apkUrl=" + apkUrl + ", apkMd5=" + apkMd5 + ", apkPath="
				+ apkPath + ", versionCode=" + versionCode + "]";
	}
