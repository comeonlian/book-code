...
public class Utils {
	...
	public static String getCityCode(String ip)
	{
		...
		try
		{
		  return (String) getCityInfoByIP(ip).get("city_code");
		}
		catch(Exception ex)
		{
	...
	public static String getCityName(String ip)
	{
		try
		{
		 return (String) getCityInfoByIP(ip).get("city_name");
		}
		catch(Exception ex)
		{}
		return "";
    ...
    public static  Map<String, Object> getCityInfoByIP(String ip) {
    	...
    	/*
        OscacheManager oscacheManager = new OscacheManagerImpl();
     
        Map<String, Object> map = oscacheManager.findCityByCDN(ip);
        String city  = (String)map.get("cityName");
