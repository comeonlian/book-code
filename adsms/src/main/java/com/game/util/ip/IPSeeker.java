...
public class IPSeeker {
    ...
    private static final String IP_FILE = IPSeeker.class.getResource("qqwry.dat").toString().replaceAll("%20"," ").substring(5);
    ...
    private IPSeeker()  {
        ...
        try {
            ipFile = new RandomAccessFile(IP_FILE, "r");
                        ...
                        System.out.println(IPSeeker.class.getResource("/QQWry.dat").toString().replaceAll("%20"," "));
...
//    	System.out.println("***ip:" + ip + "*****getCountry(ip)" + getCountry(ip) + "***getArea(ip):" + getArea(ip));
