...
<title>支付平台管理 [登录用户:<security:authentication property="principal.username"/>]</title>
  ...
  <tr>
    <td height="23" background="${ctx}/images/web/main_25.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><div align="right" class="STYLE1">今天是：<fmt:formatDate value="${date}" pattern="yyyy年MM月dd日  EEEEE"/> </div></td>
