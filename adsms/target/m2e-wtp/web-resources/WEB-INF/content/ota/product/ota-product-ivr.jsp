...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="ota-product-ivr!list.action" method="post">
  ...
  <div id="operate" class="operate">
    <div><img src="${ctx}/images/b_add.gif" alt="增加" onclick="opr_input('ota-product-ivr!input.action',false,'${authId}');"/></div>
    <div><img src="${ctx}/images/b_edit.gif" alt="修改" onclick="opr_update('ota-product-ivr!input.action','mainForm',false,'${authId}');" /></div>
    <!--  <div><img src="${ctx}/images/b_del.gif" alt="删除" onclick="opr_delete('ota-product-ivr!delAll.action','mainForm');" /></div>-->
  </div>
    <!-- start--------------------------------------- -->
