...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="short-log!smsTyxx.action" method="post">
    <input type="hidden" name="pageSmsTyxx.pageNo" id="pageNo" value="${pageSmsTyxx.pageNo}"/>
    <input type="hidden" name="pageSmsTyxx.orderBy" id="orderBy" value="${pageSmsTyxx.orderBy}"/>
    <input type="hidden" name="pageSmsTyxx.order" id="order" value="${pageSmsTyxx.order}"/>
    <input type="hidden" name="authId" id="authId" value="${authId}"/>
    <input type="hidden" name="pageSmsTyxx.pageSize" id="pageSize" value="${pageSmsTyxx.pageSize}" />
    <input type="hidden" name="pageSmsTyxx.excelExp" id="excelExp" value="${pageSmsTyxx.excelExp}" />
   <!-- 查询条件 -->
   <div id="filter" class="filter">
    ...
    <div class="where">
        ...
        <div class="and">
        	<span>计费结果值:</span>
        	<input type="text" class="small" name="filter_LIKES_status" value="${param['filter_LIKES_status']}" size="30" />
        </div>
        <div class="and">
        	<span>号码:</span>
        ...
        <div class="and">
        	<span>上行指令:</span>
        	<input type="text" class="small" name="filter_LIKES_msg" value="${param['filter_LIKES_msg']}" size="30" />
        </div>
        <div class="and">
          <span>开始时间:</span>
  ...
  <div id="operate" class="operate">
    ...
    <div id="indiv" style="width:100%;OVERFLOW-X:auto;">
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${pageSmsTyxx.result}" var="a" varStatus="c">
				<tr align="center">
					<td>${a.linkid}</td>
	  ...
	  <wlps:page page="${pageSmsTyxx}" showPageSize="true" excelExp="false" /></div>
    <!-- end--------------------------------------- -->
