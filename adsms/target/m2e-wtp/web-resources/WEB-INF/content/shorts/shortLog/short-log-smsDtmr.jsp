...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="short-log!smsDtmr.action" method="post">
    <input type="hidden" name="pageSmsTyxx.pageNo" id="pageNo" value="${pageDtmr.pageNo}"/>
    <input type="hidden" name="pageSmsTyxx.orderBy" id="orderBy" value="${pageDtmr.orderBy}"/>
    <input type="hidden" name="pageSmsTyxx.order" id="order" value="${pageDtmr.order}"/>
    <input type="hidden" name="authId" id="authId" value="${authId}"/>
    <input type="hidden" name="pageSmsTyxx.pageSize" id="pageSize" value="${pageDtmr.pageSize}" />
    <input type="hidden" name="pageSmsTyxx.excelExp" id="excelExp" value="${pageDtmr.excelExp}" />
   <!-- 查询条件 -->
  ...
  <div id="operate" class="operate">
    ...
    <div id="indiv" style="width:100%;OVERFLOW-X:auto;">
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${pageDtmr.result}" var="a" varStatus="c">
				<tr align="center">
					<td>${a.linkid}</td>
	  ...
	  <wlps:page page="${pageDtmr}" showPageSize="true" excelExp="false" /></div>
    <!-- end--------------------------------------- -->
