...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="short-log!sdkback.action" method="post">
    <input type="hidden" name="pageSdkback.pageNo" id="pageNo" value="${pageSdkback.pageNo}"/>
    <input type="hidden" name="pageSdkback.orderBy" id="orderBy" value="${pageSdkback.orderBy}"/>
    <input type="hidden" name="pageSdkback.order" id="order" value="${pageSdkback.order}"/>
    <input type="hidden" name="authId" id="authId" value="${authId}"/>
    <input type="hidden" name="pageSdkback.pageSize" id="pageSize" value="${pageSdkback.pageSize}" />
    <input type="hidden" name="pageSdkback.excelExp" id="excelExp" value="${pageSdkback.excelExp}" />
   <!-- 查询条件 -->
   <div id="filter" class="filter">
    ...
    <div class="where">
        <div class="and">
        	<span>流水号:</span>
        	<input type="text" class="small" name="filter_EQS_smsId" value="${param['filter_EQS_smsId']}" size="30" />
        </div>
        <div class="and">
        	<span>计费结果值:</span>
        	<input type="text" class="small" name="filter_LIKES_state" value="${param['filter_LIKES_state']}" size="30" />
        </div>
        <div class="and">
        	<span>号码:</span>
        	<input type="text" class="small" name="filter_LIKES_phone" value="${param['filter_LIKES_phone']}" size="30" />
        </div>
        <div class="and">
        	<span>上行内容:</span>
        	<input type="text" class="small" name="filter_LIKES_moContent" value="${param['filter_LIKES_moContent']}" size="30" />
        </div>
        <div class="and">
          <span>开始时间:</span>
  ...
  <div id="operate" class="operate">
    ...
    <div id="indiv" style="width:100%;OVERFLOW-X:auto;">
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${pageSdkback.result}" var="a" varStatus="c">
				<tr align="center">
					<td>${a.smsId}</td>
	  ...
	  <wlps:page page="${pageSdkback}" showPageSize="true" excelExp="false" /></div>
    <!-- end--------------------------------------- -->
