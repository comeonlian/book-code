...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="short-log!errorCmd.action" method="post">
    <input type="hidden" name="pageErrorCmd.pageNo" id="pageNo" value="${pageErrorCmd.pageNo}"/>
    <input type="hidden" name="pageErrorCmd.orderBy" id="orderBy" value="${pageErrorCmd.orderBy}"/>
    <input type="hidden" name="pageErrorCmd.order" id="order" value="${pageErrorCmd.order}"/>
    <input type="hidden" name="authId" id="authId" value="${authId}"/>
    <input type="hidden" name="pageErrorCmd.pageSize" id="pageSize" value="${pageErrorCmd.pageSize}" />
    <input type="hidden" name="pageErrorCmd.excelExp" id="excelExp" value="${pageErrorCmd.excelExp}" />
   <!-- 查询条件 -->
  ...
  <div id="operate" class="operate">
    ...
    <div id="indiv" style="width:100%;OVERFLOW-X:auto;">
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${pageErrorCmd.result}" var="a" varStatus="c">
				<tr align="center">
					<td>${a.customerid}</td>
	  ...
	  <wlps:page page="${pageErrorCmd}" showPageSize="true" excelExp="false" /></div>
    <!-- end--------------------------------------- -->
