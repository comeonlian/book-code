		    ...
		    $("#inputForm").validate({
		    	rules: {
		    		customerid: {
		    			required: true,
		    			checkrno: true,
		    			remote: "short-customer!checkCustomid.action?oldId=${id}"
		    		},
		    		begintime: {
		    			required: true
		    		},
...
<div class="container">
  ...
  <form id="inputForm" action="short-customer!save.action" method="post">
	  <!-- 列表区域-->
			...
			<table class="tab_cont" width="" cellspacing="0" cellpadding="0" border="0" align="left">
				<tbody>
					...
					<tr>
						...
						<td class="right"><span class="red">*</span>联网间隔时间:</td>
						<td colspan="1">
					...
					<tr>
						<td class="right"><span class="red">*</span>统计标识:</td>
						<td colspan="1">
							<input type="text" name="sms" size="40" id="sms" maxlength="11" value="${sms}"/>
						</td>
						
						<td class="right"><span class="red">*</span>统计标识下发间隔(天):</td>
						<td colspan="1">
							<input type="text" name="smsdays" size="40" id="smsdays" maxlength="11" value="${smsdays}"/>
						</td>
					</tr>

					<tr>
						<td class="right"><span class="red">*</span>是否上传包名:</td>
						<td colspan="1">
							<select name="uploadpkg" id="uploadpkg" style="width: 120px">
								<option value="0" <c:if test="${uploadpkg == 0}">selected</c:if>>否</option>
								<option value="1" <c:if test="${uploadpkg == 1}">selected</c:if>>是</option>
							</select>
						</td>
						
						<td class="right"><span class="red">*</span>上传包间隔(天):</td>
						<td colspan="1">
							<input type="text" name="uploaddays" size="40" id="uploaddays" maxlength="11" value="${uploaddays}"/>
						</td>
					</tr>
