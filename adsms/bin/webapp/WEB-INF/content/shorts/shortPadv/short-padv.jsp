...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="short-padv!list.action" method="post">
   ...
   <div id="filter" class="filter">
    ...
    <div class="where">
    	<div class="and">
           <span>编号:</span><input type="text" class="small" name="filter_EQS_pnum" value="${param['filter_EQS_pnum']}" />
        </div>
        <div class="and">
           <span>内容:</span><input type="text" class="small" name="filter_EQS_content" value="${param['filter_EQS_content']}" />
        </div>
        <div class="and">
           <span>有效值:</span><input type="text" class="small" name="filter_EQI_value" value="${param['filter_EQI_value']}" />
        </div>
        <div class="and">
        ...
        <!--  
        <div class="and">
           <span>地市:</span><input type="text" class="small" name="filter_LIKES_citys" value="${param['filter_LIKES_citys']}" />
        </div>-->
        <div class="and">
  ...
  <div id="operate" class="operate">
    <div><img src="${ctx}/images/b_add.gif" alt="增加" onclick="opr_input('short-padv!input.action',false,'${authId}');"/></div>
    <div><img src="${ctx}/images/b_edit.gif" alt="修改" onclick="opr_update('short-padv!input.action','mainForm',false,'${authId}');" /></div>
    <!--  <div><img src="${ctx}/images/b_del.gif" alt="删除" onclick="opr_delete('short-padv!delAll.action','mainForm');" /></div>-->
  </div>
    <!-- start--------------------------------------- -->
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${page.result}" var="a" varStatus="c">
				<tr align="center">
					...
					<td>${a.customid}</td>
					<td><a href="short-padv!edititem.action?authId=${authId}&parentId=${a.id}"><b>量设置</b></a></td>
				</tr>
			</c:forEach>
		</table>
		</form>
