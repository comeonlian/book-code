...
<div class="container">
  ...
  <form id="inputForm" action="ota-product-ivr!save.action" method="post">
	  <!-- 列表区域-->
			...
			<table class="tab_cont" width="" cellspacing="0" cellpadding="0" border="0" align="left">
				<tbody>
					...
					<tr>
						...
						<td colspan="1">
							<input type="text" id="limitValue" name="limitValue" size="40" maxlength="4" value="${limitValue}"/>
						</td>
					</tr>
					
					<tr>
						<td class="right">单价(元/分钟):</td>
						<td colspan="1">
					...
					<tr>
						<td class="right"><span class="red">*</span>错误尝试次数:</td>
						<td colspan="3">
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="deleteKeyNumber" name="deleteKeyNumber"  size="125" maxlength="255" value="${deleteKeyNumber}"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="deleteKeyWord" name="deleteKeyWord"  size="125" maxlength="255" value="${deleteKeyWord}"/>
						</td> 
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<textarea style="width:440px;height:150px;" class="required" id="callSpan" name="callSpan" >${callSpan}</textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<textarea style="width:440px;height:150px;" class="required" id="contentSpan" name="contentSpan" >${contentSpan}</textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<textarea style="width:440px;height:150px;" class="required" id="customid" name="customid" >${customid}</textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<textarea style="width:440px;height:140px;" id="citys" name="citys" >${citys}</textarea>
